...
- 종합 판정: **FAIL**
- 집계: PASS 6 / WARN 2 / FAIL 1
- 종료 규칙: FAIL이 하나라도 있으면 exit 1; WARN만 있으면 exit 0

| 항목 | 상태 | 상세 |
|---|---|---|
| submit/ SHA256 매니페스트 | **PASS** | 25개 파일, 1931.6 MiB → C:\dev\night\2026-07-14\task3\context\reports\freeze_manifest_2026-07-14.json |
| public LB 최고 제출 | **PASS** | numeric LB 최고 = #14 (0.77089); 기대값 = #14 (0.77089) |
...
| 디스크 여유 | **WARN** | C:\: 3.67 GiB free (WARN 기준 10.00 GiB 미만) |
| git 작업트리 | **FAIL** | 미커밋 변경:<br>M context/INDEX.md<br>?? context/daily/2026-07-14.md |
