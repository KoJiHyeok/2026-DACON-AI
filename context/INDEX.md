...
- 2026-07-13 — [daily](daily/2026-07-13.md) : **시간초과 대역전의 날** — exp #52 Qwen 하이브리드 게이트 통과 → 제출 #13 T4 10분 초과 FAIL → 속도레버 2종(정렬배칭+fast_aar) → Colab T4 30k 리허설 515s 실측 → **제출 #14 LB 0.77089 팀 최고 갱신 (89→79등, 전이율 73.5%)**
- 2026-07-14 — [daily](daily/2026-07-14.md) : D-1. 밤샘 3장(플레이북 현행화·발표 사료·freeze_check 도구) 검증 병합, 컷 0.79575로 상승(갭 −0.0249, 85등). 18:00 동결 예정
