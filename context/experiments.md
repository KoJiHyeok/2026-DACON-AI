...
| 22 | 07.06 night | char-ngram LinearSVC 독립 4번째 성분 | `scripts/components/char_svm/train_oof.py`, char_wb(2,5) max_features=300k + LinearSVC(C=0.1, balanced), 3-fold SGKF OOF + 리그 w4 add-test | OOF **0.59369**, explore4 0.41445. 리그 baseline 0.717259, best w4=1.0 → **0.718163 (+0.00090)** | 미제출 | **FAIL/폐기** — PASS 기준 +0.002 미달. 28.2% disagreement로 다양성은 있으나 성분이 약해 3-way 보정 신호가 부족 |
